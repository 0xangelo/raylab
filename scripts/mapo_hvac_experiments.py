...
from raylab.envs.hvac import DEFAULT_CONFIG as ENV_CONFIG
from plot_icaps_grid import plot_hvac_grid


SEEDS = 6

STOP_COND = {"timesteps_total": int(1e3)}
...
def experiment(**args):
    ...
    mapo_config = {
        ...
        **MAPO_CONFIG,
        "module": {
            **ACTOR_CRITIC_CONFIG,
            "model": {
                "units": (len(env_config["env_config"]["CAP"]) + 1,),
                "activation": None,
    ...
    sop_config = {**base_config, **env_config, **SOP_CONFIG}
    run_mapo_vs_sop(mapo_config, sop_config, "Original")
