...
BASE = {
    ...
    "torch_script": False,
    "actor": {
        "encoder": {"units": (64, 32), "activation": "ELU"},
        "input_dependent_scale": False,
    },
    "critic": {"encoder": {"units": (64, 32), "activation": "ELU"}},
}

XAVIER_UNIFORM = {
    "actor": {"encoder": {"initializer_options": {"name": "xavier_uniform"}}},
    "critic": {"encoder": {"initializer_options": {"name": "xavier_uniform"}}},
}
