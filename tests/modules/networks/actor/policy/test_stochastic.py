...
def base_cls():
    from raylab.modules.networks.actor.policy.stochastic import MLPStochasticPolicy
...
@pytest.fixture(scope="module")
def cont_cls():
    from raylab.modules.networks.actor.policy.stochastic import MLPContinuousPolicy
...
@pytest.fixture(scope="module")
def disc_cls():
    from raylab.modules.networks.actor.policy.stochastic import MLPDiscretePolicy
